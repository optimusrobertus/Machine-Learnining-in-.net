...
namespace MyMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\School\Exacte vakken\Informatica\Machine Learning\ML.net\myMLApp\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\rober\AppData\Local\Temp\MLVSTools\myMLAppML\myMLAppML.Model\MLModel.zip";
        ...
        {
            FileInfo _dataRoot = new FileInfo(typeof(myMLApp.Program).Assembly.Location);
